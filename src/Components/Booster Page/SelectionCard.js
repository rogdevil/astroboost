...
export function SelectionCard() {
  ...
  const UserOrderInfo = {
    extraPayment: { get: extraPayment, set: setExtraPayment },
    ...
    showModalLeaguePoint: {
      get: showModalLeaguePoint,
      set: setShowModalLeaguePoint,
    },
  ...
  const checkRank = () => {
    if (
      UserOrderInfo.rankOrder.get.indexOf(UserOrderInfo.initialRank.get) >=
      UserOrderInfo.rankOrder.get.indexOf(UserOrderInfo.destinedRank.get)
    ) {
