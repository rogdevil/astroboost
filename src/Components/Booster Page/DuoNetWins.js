  ...
  return (
    <React.Fragment>
      <div className="selection-card" id="base">
        ...
        <div className="rank">
          <p className="rank-name" onClick={toogleModelone}>
            Rank
          </p>
          <p className="rank-tier">{context.initialRank.get}</p>
        </div>
        <div className="rank">
          <p className="rank-name" onClick={toogleModelQueue}>
            Queue
          </p>
        ...
        <div className="server-lp">
          <div>
            <p className="rank-name" onClick={toogleServerModal}>
              Server
            </p>
            <p className="rank-tier">{context.server.get}</p>
          </div>
          <div>
            <p className="rank-name" onClick={toogleModelLeaguePoint}>
              League Point
            </p>
      ...
      <div className="selection-card" id="destination">
        <div className="rank">
          <h1 className="red" style={{ fontSize: "100px" }}>
            {context.netWins.get}
          </h1>
          <div>
            <input
              ...
              val="0"
              onChange={(event) => {
                context.netWins.set(event.target.value);
              }}
            />
          </div>
        </div>
