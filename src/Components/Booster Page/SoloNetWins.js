    ...
    return (
        <React.Fragment>
                    ...
                    <div className="selection-card" id="destination">
                        <div className="rank">
                            <h1 className="red" style={{fontSize: "100px"}}>{context.netWins.get}</h1>
                            <div>
                                <input type="range" className="slider" min="0" max="10" val="0" onChange={(event) => {context.netWins.set(event.target.value)}} />
                            </div>
                        </div>
